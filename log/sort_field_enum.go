...
var _SortFieldIndex = [...]uint8{0, 9, 14, 19}

const _SortFieldLowerName = "timestamplevelreqid"
...
func _SortFieldNoOp() {
	...
	_ = x[SortFieldLevel-(1)]
	_ = x[SortFieldReqID-(2)]
}

var _SortFieldValues = []SortField{SortFieldTimestamp, SortFieldLevel, SortFieldReqID}
...
var _SortFieldNameToValueMap = map[string]SortField{
	...
	_SortFieldLowerName[9:14]:  SortFieldLevel,
	_SortFieldName[14:19]:      SortFieldReqID,
	_SortFieldLowerName[14:19]: SortFieldReqID,
}

var _SortFieldNames = []string{
	_SortFieldName[0:9],
	_SortFieldName[9:14],
	_SortFieldName[14:19],
}
